...
import com.dh.commonutilslib.time.Calendar;
...
public class TimeUtil {
     ...
     *
     * @param time
     * @param format 格式，如yyyy-MM-dd HH:mm:ss  2018-09-09 09:09:09
     * @return
     */
    public static long formatStringToLong(String time, String format) {
        SimpleDateFormat formatter = new SimpleDateFormat(format);
        try {
            Date date = formatter.parse(time);
            return date.getTime();
     ...
     * 转化当前时间为年月日
     *
     * @param format 格式 如yyyy-MM-dd  2018-09-09
     * @return
     */
    public static String formatCurrentTime2String(String format) {
    ...
    public static String formatWeekToStr(int week) {
        String weekStr = "";
        switch (week) {
            case 1:
                weekStr = "星期天";
    ...
    public static String formatWeekToStr2(int week) {
        String weekStr = "";
        switch (week) {
            case 1:
                weekStr = "周日";
     ...
     * @return
     */
    public static boolean isWeekend(int week) {
        if (week == 1 || week == 7) {
            return true;
        }
        return false;
